- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/sensor/habox_esphome_verze/state`
- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/sensor/habox_ip_adresa/state`
- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/sensor/habox_mac_adresa/state`
- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/switch/esp_factory_reset/state`
- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/switch/esp_safe_mode/state`
- `habox/unit/habox5-dev-topic/B0:B2:1C:F4:90:F3/switch/esp_shutdown/state`
- `habox/unit/habox5-dev-topic/b0b21cf490f0/esp/status/debug`
- `habox/unit/habox5-dev-topic/b0b21cf490f0/sensor/habox_uptime/state`
- `habox/unit/habox5-dev-topic/b0b21cf490f0/sensor/mac_prefix/state`
- `habox/unit/habox5-dev-topic/b0b21cf490f0/sensor/mqtt_topic_prefix/state`
- `habox/unit/habox5-dev-topic/esp/status`
- `habox/unit/habox5-dev-topic/esp/status/debug`
...
esphome:
  ...
  # Nepotřebujeme přidávat MAC adresu k názvu zařízení, protože to přidáme sami
  ...
  on_boot:
    ...
    then:
      - lambda: |-
          ...
          // Nastavime topic prefix s MAC adresou - toto ovlivní všechny MQTT topiky
...
mqtt:
  ...
  discovery: false
  # Základní topic prefix - bude dynamicky upraven podle MAC adresy při spuštění
  topic_prefix: "${base_prefix}/${device_name}"
  # Systémové topiky - budou také dynamicky upraveny v on_connect
